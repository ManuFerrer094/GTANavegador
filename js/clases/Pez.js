...
function Pez(){
	...
	this.constructor = function(){
		...
		this.posX = lienzo1.width * Math.random();
		this.posY = lienzo1.height * Math.random();
	...
	this.colisionBordes = function(){
		...
		*/
		...
		color = contextoPeces.getImageData(x, y, 1, 1); // Miro hacia donde voy en x e y
		// Transparente Dar la Vuelta
		if (color.data[3] == 0) {
			//EL RANDOM HACE  QUE VAYA POR DONDE QUIERA
			this.rotZ += (Math.PI) //* (Math.random() - 0.2) * 0.1;
		}
