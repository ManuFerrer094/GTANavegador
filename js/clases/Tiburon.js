...
function Tiburon(){
	...
	//Metodos
		...
		this.animar = function(imagen) {
			...
			contexto1.save();
			contexto1.translate(this.posX-camara.vistaX, this.posY-camara.vistaY);
			contexto1.rotate(this.rotZ + Math.PI * 0.5);
			contexto1.drawImage(imagen, sx*this.sw, sy*this.sh, this.sw, this.sh, -this.sw/4 ,-this.sh/4, this.sw * 0.7,this.sh * 0.7);
			contexto1.restore();			
